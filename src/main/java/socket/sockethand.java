...
//소켓으로 접속한 client에 대한 메세지를 출력하는 역할도 하게됨
...
public class sockethand extends TextWebSocketHandler {
	...
	//ws로 접속시 해당 세션을 uri에 있는 마지막 번호에 맞는 워시배열로 생성하여 클래스 배열로 전환
	...
	public void afterConnectionClosed(WebSocketSession session, CloseStatus status) throws Exception {
		...
		System.out.println("새 클라이언트에 연결 해제 되었습니다.");
	}
	
	//채팅방에 있는 가용자에게 메세지를 전달
	@Override
