...
ex.listen(port, ()=> {
	console.log("express서버 체크 진행중!!!!");
})

//사용자 접속 정보
var userid = encodeURIComponent('cms');
var userpw = encodeURIComponent('cms1004');
var host = "34.47.116.144:27017";
var dbnm = "cms"

//mongodb 접속 경로 및 데이터베이스
...
var client = new MongoClient(uri);  //접속체
var db = null;

//Front-end가 Ajax로 호출한느 가상의 경로
